            ...
            <ul className="space-y-2 font-medium">
              <li>
                  <NavLink to="/establishments" className="flex items-center p-4 my-3  bg-fuchsia-700 text-white rounded-lg border-2  hover:bg-white hover:text-fuchsia-700 hover:border-fuchsia-700">
                    ...
                    <span className="flex-1 text-xl ml-3">Establishments</span>
                  </NavLink>
              </li>
              
              <li>
                  <NavLink to={`/products/${establishmentId}`} className="flex items-center p-4 my-3  bg-pink-600 text-white rounded-lg border-2  hover:bg-white hover:text-pink-600 hover:border-pink-600" >
                    ...
                    <span className="flex-1 text-xl ml-3 whitespace-nowrap">Products</span>
                  </NavLink>
              </li> 
                           
              <li>
                  <NavLink to={`/staff/${establishmentId}`} className="flex items-center p-4 my-3  bg-red-600 text-white rounded-lg border-2  hover:bg-white hover:text-red-600 hover:border-red-600" >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0 w-8 h-8 transition duration-75  group-hover:text-gray-900 ">
                        <path d="M4.5 6.375a4.125 4.125 0 118.25 0 4.125 4.125 0 01-8.25 0zM14.25 8.625a3.375 3.375 0 116.75 0 3.375 3.375 0 01-6.75 0zM1.5 19.125a7.125 7.125 0 0114.25 0v.003l-.001.119a.75.75 0 01-.363.63 13.067 13.067 0 01-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 01-.364-.63l-.001-.122zM17.25 19.128l-.001.144a2.25 2.25 0 01-.233.96 10.088 10.088 0 005.06-1.01.75.75 0 00.42-.643 4.875 4.875 0 00-6.957-4.611 8.586 8.586 0 011.71 5.157v.003z" />
                      </svg>
                      <span className="flex-1 text-xl ml-3 whitespace-nowrap">Staff</span>
                  </NavLink>
              </li>
              <li>
              <NavLink to={`/services/${establishmentId}`} className="flex items-center p-4 my-3  bg-amber-500 text-white rounded-lg border-2  hover:bg-white hover:text-amber-500 hover:border-amber-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0 w-8 h-8 transition duration-75 group-hover:text-gray-900 ">
                ...
                <span className="flex-1 text-xl ml-3 whitespace-nowrap">Services</span>                    
              </NavLink>
              </li>
              <li>
                  <NavLink to={`/orders/${establishmentId}`} className="flex items-center p-4 my-3  bg-lime-600 text-white rounded-lg border-2  hover:bg-white hover:text-lime-600 hover:border-lime-600">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0 w-8 h-8 transition duration-75 group-hover:text-gray-900 ">
                    ...
                    <span className="flex-1 text-xl ml-3 whitespace-nowrap">Orders</span>
                  </NavLink>
              </li>
              <li>
                  <a href="#" className="flex items-center p-4 my-3  bg-teal-500 text-white rounded-lg border-2  hover:bg-white hover:text-teal-500 hover:border-teal-500">
                    ...
                    <span className="flex-1 text-xl ml-3 whitespace-nowrap">Logout</span>
                  </a>
              </li>
            </ul>
        </div>
